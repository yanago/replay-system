...
echo "         -d '{\"source_table\":\"security_events\",\"start_time\":\"2024-01-01T00:00:00Z\",\"end_time\":\"2024-01-02T00:00:00Z\",\"speed_multiplier\":1.0,\"target_endpoint\":\"http://example.com/ingest\"}'"
echo ""
